...
@section('content')
    <div class="banner row no-margin" alt = "taxi" style="background-image: url('{{ asset('asset/img/taxi.jpg') }}');">
        ...
        <div class="container">
            <div class="col-md-8">
                <h1 class="banner-head"><span class="strong">Taxi Strasbourg</span></h1><h2 class="banner-head"><br>Votre Chauffeur au plus proche de vous</h2>
            </div>
    ...
    <div class="container">
        ...
        <div class="col-md-6 content-block">
            ...
            <a class="content-more" href="{{ url('/taxi-strasbourg') }}" target="__blank">PLUS DE RAISONS <i class="fa fa-chevron-right"></i></a>
        </div>
    </div>
</div>
    ...
    <div class="row white-section no-margin">
		...
		echo substr($_SERVER['REQUEST_URI'], strrpos($_SERVER['HTTP_HOST'],''));
	//echo $actual_link;
...
$reponse2 = $bdd->query('SELECT * FROM articles_taxi_strasbourg_base WHERE id= 2');
...
/*$reponse3 = $bdd->query('CREATE EVENT maj_taxi_strasbourg ON SCHEDULE EVERY 1 MINUTE DO UPDATE articles_taxi_strasbourg_base  SET article = 1 WHERE id= 1');
	...
	
				{
					...
					autocomplete.addListener("place_changed", () => {
								...
								if (!place.geometry || !place.geometry.location) {
									...
									window.alert("Pas de ville connu sous le nom de : '" + place.name + "'");
									return;
								}
								document.location.href="https://top-drivers.fr/client-particulier/type-transport-taxi/trajet/region-grand-est/departement-alsace-bas-rhin/villes-communes/taxi-" + place.name.toLowerCase();
