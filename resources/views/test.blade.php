                ...
                console.log(data);
				   ...
				   if (i==1)
				   {
                    ...
                    if(index==0)
                    {
                        ...
                        $('.fare-detail').append('<div class="fare-radio"><input type="radio" name="fare" id="'+value.name+'" ><label for="'+value.name+'"><div class="fade-radio-inner"><div class="name">'+value.name+'</div><div class="rate">'+value.estimated_fare+' '+currency+'</div></div></label></div>'); 
