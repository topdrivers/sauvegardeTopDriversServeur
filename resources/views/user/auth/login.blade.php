...
<div class="full-page-bg" style="background-image: url({{ asset('asset/img/background-inscription-client.jpg') }});" alt="inscription et connexion client">
        ...
        <div class="row no-margin">
            ...
            <div class="col-md-6 log-right">
                ...
                <div class="login-box row no-margin">
                    <div class="col-md-12">
                        <a class="log-blk-btn" href="{{url('register')}}">CREER NOUVEAU COMPTE</a>
                        <h3>Se connecter</h3>
                    </div>
                    ...
                    {{ csrf_field() }}                      
                        ...
                        <div class="col-md-12">
                            <button type="submit" class="log-teal-btn">SE CONNECTER</button>
                        </div>
                    </form>
