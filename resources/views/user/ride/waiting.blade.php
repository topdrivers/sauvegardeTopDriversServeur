		...
		var SwitchState = React.createClass({
			...
			changeLabel : function(){
				if(this.props.checkState == undefined){
					...
					}else if(this.props.checkState.status == 'PAYMENT'){
		            ...
		            <br/>
		            	...
		            	<dl className="dl-horizontal left-right">
                           ...
                           @endif
                            ...
                            <dd>{this.props.currency}{this.props.checkState.payment.total_amount_given}</dd> 
                            <dt className="big">@lang('user.ride.amount_paid')</dt>
                            <dd className="big">{this.props.currency}{this.props.checkState.payment.total_amount_given}</dd>
                        </dl>
		        </div>
				);
			}
			...
			render: function(){
				...
				<div>
					...
					<div className="status">
                    	...
                    	<button type="submit" className="full-primary-btn fare-btn">CONTINUE TO PAY - {this.props.currency}{this.props.checkState.payment.total_amount_given}</button>   
                    </form>
		        </div>
				);
			}
