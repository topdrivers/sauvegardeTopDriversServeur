                    ...
                    <div class="card card-block" id="create-ride">
                        ...
                        <form id="form-create-ride" method="POST">
                            <div class="row">
                                ...
                                <label for="first_name">Firsto Name</label>
                                <input type="text" class="form-control" name="first_name" id="first_name" placeholder="Firsto Name" >
                            </div>
                        </div>
                        <div class="col-xs-6">
                            <div class="form-group">
                            ...
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="d_address" class="form-control" id="d_address" placeholder="Dropoff Address" autocomplete="off">
