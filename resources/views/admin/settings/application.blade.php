    ...
    <div class="container-fluid">
    	<div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{ route('admin.settings.store') }}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					<label for="fb_app_secret" class="col-xs-2 col-form-label">Orgin Location Name</label>
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ Setting::get('orgin_name')  }}" name="orgin_name" required id="orgin_name" placeholder="Name">
					</div>
				</div>
								<div class="form-group row">
					<label for="fb_app_secret" class="col-xs-2 col-form-label"> Orgin Latitute </label>
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ Setting::get('orgin_latitude')  }}" name="orgin_lat" required id="orgin_lat" placeholder="Latitute">
					</div>
				</div>
								<div class="form-group row">
					<label for="fb_app_secret" class="col-xs-2 col-form-label">Orgin Longitute</label>
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ Setting::get('orgin_longitude')  }}" name="orgin_lng" required id="orgin_lng" placeholder="Longitute">
					</div>
				</div>
