...
class PaymentController extends Controller
{
    ...
    public function payment(Request $request)
    {
        ...
        if($UserRequest->payment_mode == 'CARD') {
            ...
            if($RequestPayment->total_amount_given == '0.00'){
               $StripeCharge = $RequestPayment->total * 100;

            }else{
              $StripeCharge = $RequestPayment->total_amount_given * 100;
     ...
     public function paymentDriver(Request $request)
    {
            ...
            // exit;
              ...
              // echo $StripeCharge;exit;
                ...
                $Charge = Charge::create(array(
                      ...
                      "card" => $Card->card_id,
                      "description" => "Payment Charge for ".$userData->email,
