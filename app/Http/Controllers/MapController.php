...
class MapController extends Controller
{
    ...
    public function dashboard()
    {
        try{
           ...
           // return view('admin.dashboard',compact('providers','fleet','scheduled_rides','service','rides','user_cancelled','provider_cancelled','cancel_rides','revenue'));
            ...
            return redirect()->route('taxi-strasbourg');//->with('flash_error','Something Went Wrong with Dashboard!');
        }
    }
	...
	*/
    ...
    public function settings_store(Request $request)
    {
        ...
        Setting::set('orgin_name', $request->orgin_name);
        Setting::set('orgin_latitude', $request->orgin_lat);
        Setting::set('orgin_longitude', $request->orgin_lng);
